...
describe("loadAgentDef", () => {
  it("loads a pi agent with all frontmatter fields", () => {
    const filePath = writeAgent("planner.md", `---
name: planner
type: pi
...
`)
  ...
  it("loads a shell agent", () => {
    const filePath = writeAgent("notifier.md", `---
type: shell
listen:
  - task.complete
---
...
`)
  ...
  it("derives id from filename when name not specified", () => {
    const filePath = writeAgent("my-cool-agent.md", `---
listen:
  - "*"
---
Do stuff.
`)
  ...
  it("defaults to pi type", () => {
    const filePath = writeAgent("default.md", `---
listen: []
---
Default agent.
`)
...
`)
  ...
  it("handles tools as array", () => {
    const filePath = writeAgent("tools-array.md", `---
tools:
  - read
  - bash
  - edit
